<template>
  ...
  >
    <el-form ref="refForm" label-width="150px" :inline="false" :model="subForm" :rules="formRules" class="pr-5">
      <el-form-item label="角色描述" prop="roleDesc" :rules="formRules.isNotNull" label-position="left">
        <el-input v-model="subForm.roleDesc" class="widthPx-150" placeholder="角色描述" />
      </el-form-item>
    </el-form>
    <template #footer>
...
let showModal = (isEdit, detailData) => {
  if (isEdit) {
    dialogTitle.value = `编辑【${detailData.roleName}】`
