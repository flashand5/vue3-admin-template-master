...
<template>
  ...
  <div class="login-container columnCC">
    <el-form ref="refloginForm" class="login-form" :model="formInline" :rules="formRules">
      ...
      <div class="tip-message">{{ tipMessage }}
        <el-link type="primary" style="float: right;margin-right: 4px;margin-top: 3px" @click="resetPassClick">忘记密码？</el-link>
      </div>
    ...
    <ResetPass v-if="showFrom" ref="refResetPass" @hideComp="hideComp"/>
  </div>
</template>
...
//使用 AutoImport 的 vite.config.js 自动导入
